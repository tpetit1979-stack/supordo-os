...
| 15 | Terminologie facturation électronique | `06` §2, `07`, `08` §14, `09` Q13, `12` T4 | « PDP » (Plateforme de Dématérialisation Partenaire) | `docs/product-blueprint-antigravity/06-ANNEXE-recherche-api-candidats.md` §9.2 | Décret n° 2026-677 : notion unique de « plateforme agréée » (PA) | Interface nommée d'après un statut juridique supprimé — **hors périmètre de `16`-`19`, voir §9** |
