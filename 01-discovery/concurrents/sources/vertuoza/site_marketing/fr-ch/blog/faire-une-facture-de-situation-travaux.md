---
url: https://www.vertuoza.com/fr-ch/blog/faire-une-facture-de-situation-travaux
url_finale: https://www.vertuoza.com/fr-ch/blog/faire-une-facture-de-situation-travaux
...
💡 Attention quand même : l’état d’avancement ne remplacera jamais un [bon rapport de chantier clair et illustré](https://www.vertuoza.com/fr-ch/blog/rediger-rapport-de-chantier) !

## Faire une facture de situation travaux en 12 étapes

Pour gagner en efficacité et en clarté, pensez à [utiliser un logiciel de facturation pour le bâtiment](https://www.vertuoza.com/fr-ch/blog/pourquoi-utiliser-logiciel-devis-facture-batiment). De cette façon, l’outil digital part du devis et établit toutes les factures et commandes matériaux sur base de celui-ci.
...
👉 Dans le [logiciel de facturation travaux Vertuoza](https://www.vertuoza.com/fr-ch/fonctionnalites/le-devis), vous avez ma possibilité de modifier autant de fois que vous le souhaitez l’état d’avancement travaux ou situation tant que la facture n’est pas générée. C’est très pratique en cas d’erreur ou de malentendu avec le client.
...
Facilitez la facturation de vos chantiers avec [notre modèle Excel de facture de situation](https://eu1.hubs.ly/H06nNzr0). Téléchargez dès maintenant cet outil qu’il vous suffit d’adapter à votre chantier. Le calcul est alors automatique. Cet Excel est une base qu’il ne vous reste qu’à développer.

Pour aller plus loin, gagner en sérénité et avoir une bonne gestion de la facturation de vos chantiers, passez à un [logiciel de devis et factures pour le bâtiment !](https://www.vertuoza.com/fr-ch/fonctionnalites/le-devis)
