---
url: https://www.vertuoza.com/fr-ch/politique-en-matiere-de-cookies
url_finale: https://www.vertuoza.com/fr-ch/politique-en-matiere-de-cookies
...
1.1 La présente politique en matière de cookies (la « Politique Cookies ») régit l’utilisation de cookies et autres technologies similaires (les pixels de suivis, par exemple) (désignés ensemble par le terme « Cookies ») par VERTUOZA, société à responsabilité limitée de droit belge, ayant son siège à 1402 Nivelles (Belgique), rue Louis Braille, 16, enregistrée auprès de la Banque-Carrefour des Entreprises sous le numéro 0737.828.718, identifiée auprès de l’Administration générale de la Fiscalité (TVA) sous le numéro BE0737.828.718, et inscrite au Registre des Personnes Physiques du Brabant wallon (« Vertuoza », la « Société », « nous », « notre » ou « nos »).
...
2.1 Pour toute question, remarque ou réclamation éventuelle relative à la présente Politique Cookies ou pour toute autre question relative au traitement de vos données à caractère personnel, n’hésitez pas à nous envoyer un e-mail à l’adresse suivante : marketing@vertuoza.com ou à nous envoyer un courrier à l’adresse postale reprise ci-dessus.
...
(i)      en suivant les instructions et en remplissant le formulaire accessible via ce [lien](https://www.autoriteprotectiondonnees.be/citoyen/agir/introduire-une-plainte) ;
...
(iv)    en envoyant un e-mail à l’adresse suivante : [contact@apd-gba.be](mailto:contact@apd-gba.be).
...
3.2.1 Les Cookies permettent à nos Services de récolter et stocker des informations liées à votre visite. Ces informations peuvent ensuite être utilisées à différentes fins. Par exemple, nous utilisons principalement des Cookies pour : (i) retenir les choix que vous effectuez concernant le dépôt de Cookies sur votre Terminal lorsque vous consultez nos Services, ou (ii) identifier et suivre votre comportement de navigation sur nos Services. Tout ceci nous permet d'adapter nos Services à vos intérêts et besoins. Les Cookies peuvent notamment reprendre des informations relatives aux pages que vous avez visitées sur nos Services.
...
4.1.2 Nos Services peuvent utiliser à la fois des Cookies internes et des Cookies de tiers. Les Cookies internes sont déposés sur votre Terminal directement par nos Services. Les Cookies de tiers sont déposés sur votre Terminal par d'autres sites web et services.
...
###### 4.3 QUALITICATION RETENUE EN FONCTION DE LA DURÉE DE CONSERVATION
...
5.1.1 Les Cookies strictement nécessaires contribuent à une navigation optimale sur nos Services. Ces Cookies permettent d’activer certaines fonctionnalités essentielles à l’utilisation de nos Services.
...
5.2.1 Ces Cookies améliorent votre expérience de nos Services. Ils permettent de retenir les préférences et choix que vous opérez sur nos Services.

###### 5.3 COOKIES DE PERFORMANCE

5.3.1 Ces Cookies analysent votre navigation et nous aident à rassembler un ensemble d’informations liées à votre utilisation de nos Services. Ces Cookies contribuent également à améliorer la performance de nos Services.

###### 5.4 COOKIES ANALYTIQUE

5.4.1 Les cookies analytiques collectent les données de manière anonyme sur l'activité d’un utilisateur sur un site et sur la façon dont il accède au site.

###### 5.5 COOKIES DIVERS

5.5.1 Ces Cookies sont principalement des cookies de publicité ou (cookies marketing). Ils sont utilisés pour suivre les utilisateurs à travers différents sites afin d'afficher des publicités personnalisées en fonction de leur comportement en ligne.
...
6.2 Vous pouvez à ce stade faire le choix d’accepter ou de refuser le dépôt de Cookies ou leur lecture sur votre Terminal. Vous pouvez également personnaliser vos choix par finalités et sauvegarder la sélection.

6.3 Nous retiendrons vos choix pour la poursuite de votre navigation sur nos Services et ce pendant une durée d’un (1) an. Vous pouvez modifier ou retirer votre consentement à tout moment en suivant les instructions reprises à l’article 7 ci-dessous.
...
Vous pouvez à tout moment paramétrer l’utilisation des Cookies via notre outil de gestion de Cookies en cliquant sur qui s’affiche en bas de page du Services.
...
●      Pour [Google Chrome](https://support.google.com/chrome/answer/95647)

●      Pour [Internet Explorer](https://support.microsoft.com/en-us/topic/delete-and-manage-cookies-168dab11-0753-043d-7c16-ede5947fc64d)

●      Pour [Firefox](https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop)

●      Pour [Safari](https://support.apple.com/en-ie/guide/safari/sfri11471/mac)

●      Pour [Safari mobile](https://support.apple.com/en-us/HT201265)

●      Pour [Microsoft Edge](https://support.microsoft.com/en-us/windows/microsoft-edge-browsing-data-and-privacy-bb8174ba-9d73-dcf2-9b4a-c582b4e640dd)
...
9.2 La version la plus récente de notre Politique Cookies sera toujours accessible sur nos Services via l’onglet dédié en pied de page de chacune des pages de nos Services. En tête de page, nous reprenons toujours à titre d’information la date de dernière modification de notre Politique Cookies. N’hésitez également pas à nous envoyer un email à l’adresse suivante : marketing@vertuoza.com si vous souhaitez consulter des versions antérieures de notre Politique Cookie.