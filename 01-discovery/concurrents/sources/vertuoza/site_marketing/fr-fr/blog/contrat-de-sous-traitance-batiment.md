---
url: https://www.vertuoza.com/fr-fr/blog/contrat-de-sous-traitance-batiment
url_finale: https://www.vertuoza.com/fr-fr/blog/contrat-de-sous-traitance-batiment
...
En moyenne, [76 % des entreprises de construction](https://www.batiactu.com/edito/construction-plus-gros-consommateur-sous-traitants-47032.php) ont recours à la **sous-traitance**.
...
## Sous-traitance dans le BTP : de quoi s’agit-il exactement ?
...
**💡 Bon à savoir** : En France, la sous-traitance dans le secteur du bâtiment est strictement réglementée, notamment par la [loi du 31 décembre 1975](https://www.legifrance.gouv.fr/loda/id/JORFTEXT000000889241). Cette loi protège les droits du sous-traitant, en particulier en matière de paiement. Elle impose certaines obligations à l’entrepreneur principal, comme celle de déclarer le sous-traitant auprès du maître d’ouvrage (le client final du projet).
...
Cet article pourrait aussi vous plaire : [Votre gestion sous-traitants améliorée avec un logiciel de chantier](https://www.vertuoza.com/fr-fr/blog/logiciel-gestion-sous-traitants-batiment)

### Rédiger un contrat de sous-traitance : les règles à respecter
...
Le contrat de sous-traitance doit être rédigé par le donneur d’ordre, soit l’entreprise principale qui engage le sous-traitant. Voici un [modèle de contrat de sous-traitance valable pour le BTP](https://www.fntp.fr/sites/default/files/content/cg_contrat_de_sous-traitance_2020_v_def_0.pdf) sur lequel vous appuyer pour rédiger votre document. 

Cet article pourrait aussi vous plaire : [Sous-traitance : les clés pour une collaboration réussie](https://www.vertuoza.com/fr-fr/blog/sous-traitance-les-cles-pour-une-collaboration-reussie)

## Le contrat de sous-traitance dans la construction en Belgique

Comme en France, en Belgique, la sous-traitance permet à un entrepreneur principal de déléguer une partie des travaux à des partenaires spécialisés en raison de contraintes de temps ou par manque d’expertise. Dans ce cas, l’entrepreneur principa**l agit comme maître d’ouvrage vis-à-vis du sous-traitant**, avec des obligations similaires à celles d’un maître d’ouvrage traditionnel.
...
Voici un [modèle de contrat de sous-traitance de travaux de construction](https://vlex.be/vid/sous-traitance-travaux-contruction-40805223) sur lequel vous appuyer pour rédiger ce document en Belgique. 
...
Si vous souhaitez en rédiger, vous pouvez vous appuyer sur ce [modèle de contrat de sous-traitance](https://implenia.com/fileadmin/implenia.com/ueber-uns/organisation/einkauf/schweiz/info-service/einkaufsbedingungen/generalunternehmungen/WV_GU_franz.pdf).
