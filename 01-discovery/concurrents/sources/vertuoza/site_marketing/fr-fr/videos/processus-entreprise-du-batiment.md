---
url: https://www.vertuoza.com/fr-fr/videos/processus-entreprise-du-batiment
url_finale: https://www.vertuoza.com/fr-fr/videos/processus-entreprise-du-batiment
...
3. Les travaux auxquels le maître d’ouvrage veut participer,
4. Votre plan de communication avec les différents intervenants,
5. La source unique sur laquelle toutes les informations sont centralisées afin que votre équipe puisse accéder à toutes les données dont elle a besoin,
6. Vos stratégies pour gérer les risques professionnels,
7. Votre feuille de route : elle détermine les dépendances à garder en tête,
8. Vos méthodes de contrôle de coût afin de maîtriser le budget,
9. Votre objectif.
10. L’exécution : votre plan de communication assurera la réussite de cette phase. Pour cela, échangez avec vos clients, mettez à jour votre équipe (départ et entrée de nouveaux collaborateurs) et notez les progressions du projet dans un document accessible à tous.
11. La mise en service : dernière vérification avant présentation au maître d’ouvrage (défauts, anomalies, etc.) et présentation du livrable.
12. La réception du chantier et le début de la période de garantie.
13. La clôture du projet.
