---
url: https://documentation.openfire.fr/mentions
url_finale: https://documentation.openfire.fr/mentions
date_collecte: 2026-09-06
destination: documentation_2
---

Mentions légales et politique de confidentialité OpenFire

            

            La société OpenFire, soucieuse des droits des individus, a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits. 
...
1.2 Éditeur (ci-après « l'éditeur ») :
            ...
            OpenFire SAS au capital de 30 000 €
            

            Siège social est situé : Rue de la terre Victoria, Bâtiment E, 35760, Saint Grégoire
            

            Immatriculée au RCS de Rennes 750 740 193
            

            Représentée par Aymeric Kremer, en sa qualité de Président
            

            Coordonnées : 
             02 99 54 23 42 / contact@openfire.fr
...
OpenFire est hébergé par OVH, dont le siège social est situé 2 rue Kellermann 59100 Roubaix - France.
...
1.4 Délégué à la protection des données (DPO) :
            ...
            Contact : Aymeric Kremer - ak@openfire.fr, 
...
Article 7 - Collecte et protection des données
            ...
            Vos données sont collectées par la société OpenFire.
...
- En nous contactant, à l’adresse suivante :  5 rue de la Garenne - ZA la Brosse 35520 La Chapelle des Fougeretz  .

- Ou par email, à l’adresse :  contact@openfire.fr    

            Vous pouvez aussi vous adresser à notre délégué à la protection des données : Aymeric Kremer, ak@openfire.fr, qui est à votre disposition pour toute question relative à la protection de vos données personnelles.
...
Article 12 - Offres commerciales
            ...
            Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : contact@openfire.fr.
            

            Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : contact@openfire.fr.
...
Les présentes conditions d'utilisation du site sont régies par la loi française et soumises à la compétence des tribunaux du siège social de l'éditeur, sous réserve d'une attribution de compétence spécifique découlant d'un texte de loi ou réglementaire particulier.
            ...
            Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : contact@openfire.fr.