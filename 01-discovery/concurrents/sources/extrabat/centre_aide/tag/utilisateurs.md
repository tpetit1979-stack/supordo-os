---
url: https://servicescompris.extrabat.com/tag/utilisateurs
url_finale: https://servicescompris.extrabat.com:443/tag/utilisateurs/
...
2. **Modifier votre mot de passe** : dans la section Identifiants, vous pouvez changer votre mot de passe en indiquant votre ancien mot de passe.
				...
				[créer un mot de passe sécurisé]dans Extrabat, celui-ci doit au moins contenir au moins :
- une minuscule ;
- une majuscule ;
- un chiffre ;
...
1. **Demander la réinitialisation par le support Extrabat** : si vous êtes un administrateur et que vous avez oublié votre mot de passe, vous devez contacter le**support Extrabat** à l’adresse[support@extrabat.com](mailto:support@extrabat.com) ou[__09 87 87 69 20__](<tel:09 87 87 69 20>) pour demander la réinitialisation de votre mot de passe.
