---
url: https://servicescompris.extrabat.com/tag/synchroniser-mon-agenda-avec-mon-telephone-sous-android
url_finale: https://servicescompris.extrabat.com:443/tag/synchroniser-mon-agenda-avec-mon-telephone-sous-android/
...
Vous devez télécharger l’application [DAVx⁵](https://play.google.com/store/apps/details?id=at.bitfire.davdroid&hl=fr&gl=US), disponible depuis le Google Play Store.
...
2.  Cliquez sur le menu pour ajouter un compte et choississez l’option « Connexion avec une URL et un nom d’utilisateur ».
  - Récupérez vos information depuis vos [Préférences utilisateurs, Section Agenda](https://www.myextrabat.com/preferences)
  - Renseignez l’adresse du serveur, votre nom d’utilisateur et votre mot de passe de synchronisation :
    - Adresse du serveur : [https://synchro.extrabat.com/caldav.php/*********/](https://synchro.extrabat.com/caldav.php/*********/)
    - Nom d’utilisateur : ************
    - Mot de passe : ******
  - Adresse du serveur : 
3. Récupérez vos information depuis vos 
4. Après avoir cliquer sur « Se Connecter », vous pourrez nommer votre compte (par exemple Agenda Extrabat) afin de le distinguer facilement depuis votre agenda.
