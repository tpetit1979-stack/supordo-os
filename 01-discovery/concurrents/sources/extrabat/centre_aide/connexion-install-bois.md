---
url: https://servicescompris.extrabat.com/connexion-install-bois
url_finale: https://servicescompris.extrabat.com:443/connexion-install-bois/
date_collecte: 2026-09-09
destination: centre_aide
---

Install Bois, une application métier dédiée aux installateurs de chauffage au bois (cheministes, ramoneurs, âtriers), est désormais connectée à [Extrabat Chauffage, le logiciel des chauffagistes](https://www.extrabat.com/chauffage/). Cette intégration permet de gagner du temps au quotidien et d’éviter les ressaisies d’informations entre les deux outils métiers.

## À quoi sert Install Bois ?

Cette application a été conçue pour accompagner les professionnels du secteur bois-énergie dans leur quotidien. Elle offre des outils pratiques pour simplifier la conformité des installations et des [entretiens](https://servicescompris.extrabat.com/activer-les-relances-par-sms-a-vos-clients-de-vos-contrats-dentretien/), mais aussi optimiser la gestion des chantiers.
...
Pour toute question sur cette intégration ou son activation, vous pouvez contacter notre support ou celui d’Install Bois au [09 72 54 16 79](<tel:09 72 54 16 79>).